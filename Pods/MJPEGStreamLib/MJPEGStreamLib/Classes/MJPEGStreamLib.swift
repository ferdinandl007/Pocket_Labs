...
open class MJPEGStreamLib: NSObject, URLSessionDataDelegate {
    ...
    open func urlSession(_: URLSession, dataTask _: URLSessionDataTask, didReceive _: URLResponse, completionHandler: @escaping (URLSession.ResponseDisposition) -> Void) {
    ...
    open func urlSession(_: URLSession, dataTask _: URLSessionDataTask, didReceive data: Data) {
        receivedData?.append(data)
    }

    // NSURLSessionTaskDelegate

    open func urlSession(_: URLSession, task _: URLSessionTask, didReceive challenge: URLAuthenticationChallenge, completionHandler: @escaping (URLSession.AuthChallengeDisposition, URLCredential?) -> Void) {
