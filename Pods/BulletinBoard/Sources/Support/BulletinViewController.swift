...
extension BulletinViewController {
    ...
    internal func gestureRecognizer(_: UIGestureRecognizer, shouldReceive touch: UITouch) -> Bool {
...
extension BulletinViewController {
    ...
    @objc fileprivate func handleTap(recognizer _: UITapGestureRecognizer) {
        dismissIfPossible()
    }
